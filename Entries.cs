    ...
    class Entries
    {
        ...
        public List<DataGridViewRow> getEntries(bool search = true)
        {
            if (search)
            {
                ...
                // Additional paths for executable files
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\RunMRU");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\App Paths");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Run");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\RunOnce");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\StartPage");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\RecentDocs");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\ComDlg32\OpenSavePidlMRU");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\ComDlg32\LastVisitedPidlMRU");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\ShellNoRoam\MUICache");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Search\RecentApps");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\UFH\SHC");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\UserAssist");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FileExts");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\StartPage\NewShortcuts");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\StartPage2");
                getEntriesForKey(@"SOFTWARE\Microsoft\Windows\CurrentVersion\Installer\UserData");
            }
